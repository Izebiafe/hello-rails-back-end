...
- The api is consumed by this [React project](https://github.com/Izebiafe/hello-react-front-end.git)
...
```
  ...
  git clone git@github.com:DevaWinner/hello-rails-back-end.git
```
